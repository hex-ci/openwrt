...
svn export https://github.com/openwrt/packages/trunk/net/telnet-bsd package/telnet
...
git clone --depth=1 https://github.com/rosywrt/luci-theme-rosy package/luci-theme-rosy
